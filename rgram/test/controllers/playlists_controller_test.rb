...
class PlaylistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create playlist" do
    assert_difference('Playlist.count') do
      post playlists_url, params: { playlist: { artist: @playlist.artist, music_id: @playlist.music_id, title: @playlist.title } }
    end
  ...
  test "should update playlist" do
    patch playlist_url(@playlist), params: { playlist: { artist: @playlist.artist, music_id: @playlist.music_id, title: @playlist.title } }
